...
// Helper function to write string to DataView (internal)
...
// Export decode function (needed by App.tsx and internally)
...
// Export encode function (needed by App.tsx)
...
// Export pcmToWav function (needed by App.tsx)
export function pcmToWav(pcmData: Uint8Array, sampleRate: number, numChannels: number, bitsPerSample: number): Uint8Array {
  ...
  view.setUint32(4, chunkSize, true); // Chunk Size
